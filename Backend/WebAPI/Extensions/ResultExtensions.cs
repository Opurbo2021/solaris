...
public static class ResultExtensions
{
    ...
    /// <returns>
    /// <see cref="NotFoundObjectResult"/> for <see cref="NotFound"/>,
    /// <see cref="BadRequestObjectResult"/> for <see cref="BadRequest"/>,
    /// <see cref="ConflictObjectResult"/> for <see cref="Conflict"/>,
    ...
    private static ActionResult HandleError(Result result)
    {
        return result.StatusCode switch
        {
            ...
            ResultStatusCode.Unauthorized => new UnauthorizedObjectResult(result.Error),
